...
namespace QuantLib {
    ...
    */
    ...
    public:
      BaseCorrelationLossModel(Handle<BaseCorrelationTermStructure<Corr2DInt_T>> correlTS,
      ...
      : localCorrelationAttach_(ext::make_shared<SimpleQuote>(0.)),
        ...
        recoveries_(std::move(recoveries)), correlTS_(std::move(correlTS)), copulaTraits_(traits) {
          registerWith(correlTS_);
