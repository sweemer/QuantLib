...
namespace QuantLib {
    ...
    */
        ...
        public:
            ...
            std::vector<Real> operator()(const F& f) const {
                ...
                std::for_each(term.begin(), term.end(),
                              [i, this](Real x) -> Real { return x * w_[i]; });
                ...
                for (i--; i >= 0; --i) {
                    ...
                    std::transform(term.begin(), term.end(), sum.begin(), 
                                   sum.begin(),
                                   [i, this](Real x, Real y) -> Real { return w_[i]*x + y; });
                }
                return sum;
            }
        };
        ...
        */
        ...
        void spawnFcts() const {
            integrationEntries_[levelSpawn-1] =
                [this](ext::function<Real (const std::vector<Real>&)> f, Real x){
                    return scalarIntegrator<levelSpawn>(f, x);
                };
            integrationEntriesVR_[levelSpawn-1] =
                [this](const ext::function<std::vector<Real>(const std::vector<Real>&)>& f, Real x){
            ...
            const Real mFctr) const 
        {
            ...
            return integral_([&f, this](Real x){ return scalarIntegrator<intgDepth-1>(f, x); });
        }
        ...
        {
            varBuffer_[intgDepth-1] = mFctr;
            return integralV_([&f, this](Real x){ return vectorIntegratorVR<intgDepth-1>(f, x); });
        }
        ...
        const ext::function<Real (const std::vector<Real>& v1)>& f) const
    {
        ...
        return integral_([&f, this](Real x){ return integrationEntries_[dimension_-1](ext::cref(f), x); });
    }
    ...
    {
        return integralV_([&f, this](Real x){ return integrationEntriesVR_[dimension_-1](ext::cref(f), x); });
    } 
    ...
    inline void GaussianQuadMultidimIntegrator::spawnFcts<1>() const {
        integrationEntries_[0] = [this](const ext::function<Real(const std::vector<Real>&)>& f,
